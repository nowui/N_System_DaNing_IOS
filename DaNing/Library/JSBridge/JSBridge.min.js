...
connectJSBridge(function(bridge) {
    bridge.init(function(message, responseCallback) {
        bridge.callEventCallback(responseCallback, {}, message);
    })
